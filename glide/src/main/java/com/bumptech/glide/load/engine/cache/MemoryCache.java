...
/**
 * An clip_interface for adding and removing resources from an in memory cache.
 */
public interface MemoryCache {
    /**
     * An clip_interface that will be called whenever a bitmap is removed from the cache.
     */
