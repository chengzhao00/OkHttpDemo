...
/**
 * A factory clip_interface for translating an arbitrarily complex data model into a concrete data type that can be used
 * by an {@link DataFetcher} to obtain the data for a resource represented by the model.
 *
 * <p>
 *  This clip_interface has two objectives:
