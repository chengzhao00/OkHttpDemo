...
/**
 * An clip_interface for writing to and reading from a disk cache.
 */
public interface DiskCache {

    /**
     * An clip_interface for lazily creating a disk cache.
     */
    interface Factory {
    ...
    /**
     * An clip_interface to actually write data to a key in the disk cache.
     */
    interface Writer {
        /**
     ...
     * @param writer An clip_interface that will write data given an OutputStream for the key.
     */
