...
/**
 * A {@link GlideAnimation GlideAnimation} that accepts an clip_interface
...
public class ViewPropertyAnimation<R> implements GlideAnimation<R> {
     ...
     * {@link Animator} clip_interface that can apply an animation
     * to a view.
     *
    ...
    /**
     * An clip_interface that allows an animation to be applied on or started from an {@link View}.
     */
