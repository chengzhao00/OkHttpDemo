...
/**
 * An clip_interface that allows a transformation to be applied to {@link View}s in
 ...
 * necessary arguments and will therefore be forced to ignore the animation. This clip_interface is a compromise that
...
public interface GlideAnimation<R> {
    ...
    /**
     * An clip_interface wrapping a view that exposes the necessary methods to run the various types of android animations
     * ({@link ViewAnimation},
