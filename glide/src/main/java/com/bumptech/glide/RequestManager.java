...
public class RequestManager implements LifecycleListener {
    ...
    /**
     * An clip_interface that allows a default set of options to be applied to all requests started from an
     * {@link RequestManager}.
     */
    ...
    /**
     * Sets an clip_interface that can apply some default options to all Requests started using this {@link RequestManager}.
     *
     * <p>
